...
class _CreateTaskFormBloc extends FormBloc<String, String> {
  ...
  Future<void> onLoading() async {
    try {
      ...
      if (result is! List<ShiftsModel>?) {throw Exception(Messages.weirdResponse);}

      final res = result ?? [];

      shifts.updateItems(res.map((e) => DateFormat("MMMM d, yyyy 'at' h:m:ss a").format(e.begin ?? DateTime.now(),),).toList(),);
...
class CustomScaffold extends StatelessWidget {
                ...
                onPressed: () {
                  showCustomModalBottomSheet(
                    ...
                    content: BlocProvider<_CreateTaskFormBloc>.value(
                      ...
                      builder: (context) {
                        final formBloc = context.read<_CreateTaskFormBloc>();
                        return FormBlocListener<_CreateTaskFormBloc, String, String>(
                  ...
                  await context.read<TasksController>().addTask(
                    message: message,
                    shift: shift,
                  ).then((result) {
                    if (result != null) {
                      ...
                      context.push(Uri(path: Routes.tasks, queryParameters: {'shift': shift},).toString(),);
                    }
                  });
                  },
                  ...
                  child: BlocBuilder<_CreateTaskFormBloc, FormBlocState<String, String>>(
  ...
  builder: (context, state) {
    ...
    return ListTile(
          ...
          subtitle: RadioButtonGroupFieldBlocBuilder<String>(
